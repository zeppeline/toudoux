...
},{"./modules/tasks.js":3,"jQuery":1}],3:[function(require,module,exports){
'use strict';
...
var tasks = {
    ...
    // Events functions
    'e_createTask': function e_createTask(e) {
        e.preventDefault();
    ...
    // Other methods
    'findNewTags': function findNewTags() {
...
},{"../utils/errors.js":4,"jQuery":1}],4:[function(require,module,exports){
'use strict';
...
var errors = {
    ...
    'validation': function validation(element) {
        var message = arguments.length <= 1 || arguments[1] === undefined ? 'This field is required' : arguments[1];
